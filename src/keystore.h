...
#ifndef UBICOIN_KEYSTORE_H
#define UBICOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/ubicoin/bips/blob/master/bip-0013.mediawiki
