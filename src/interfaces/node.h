...
#ifndef UBICOIN_INTERFACES_NODE_H
#define UBICOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ubicoin node (ubicoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // UBICOIN_INTERFACES_NODE_H
