...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ubicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ubicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ubicoin transaction") + "\n" +
              "  ubicoin-tx [options] -create [commands]   " + _("Create hex-encoded ubicoin transaction") + "\n" +
              "\n";
