 ...
 */
#ifndef UBICOIN_UTIL_H
#define UBICOIN_UTIL_H
...
extern const char * const UBICOIN_CONF_FILENAME;
extern const char * const UBICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("ubicoin-%s", name);
