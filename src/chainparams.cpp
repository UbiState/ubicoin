...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.ubicoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ubicointools.com");
        vSeeds.emplace_back("dnsseed.ubicoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ubicointools.com");
        vSeeds.emplace_back("seed-b.ubicoin.loshan.co.uk");
