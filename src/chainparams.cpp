...
// Copyright (c) 2016 uBioshi
// Copyright (c) 2009-2019 The Bitcoin Core developers
// Copyright (c) 2016-2020 The Ubicoin Core developers
...
public:
    CMainParams() {
		...
		{  5072, uint256S("0xe2f9b51a4461b23c844537c52728d255235a5e7877d4817642a273f3c7208b1a")},
		{  22683, uint256S("0x5484f4a53ee8780426f661bf62caeebc9d9ca39cde259da3f673c2bfef5b71e8")},
            }
        };

        chainTxData = ChainTxData{
            
            1589913845, // * UNIX timestamp of last known number of transactions
            25105,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1588951508, 3641857, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x76e94478c87faf0d978e007c771548122badbb6e6576fa27da897554b3eb5464"));
        assert(genesis.hashMerkleRoot == uint256S("0x84b460915ae89104c94de2ea3d0ade0245203dc36906f3a9508169b5da0b0d57"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x76e94478c87faf0d978e007c771548122badbb6e6576fa27da897554b3eb5464")},
            }
        };

        chainTxData = ChainTxData{
            1588951508, // * UNIX timestamp of last known number of transactions
            0,  // * total number of transactions between genesis and that timestamp
                    //   (the tx=... number in the SetBestChain debug.log lines)
            1.907     // * estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1588953041, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xed0d32cd64dab7185bb5317678ea31d338e3847e483f8e0d450e509880873d15"));
        assert(genesis.hashMerkleRoot == uint256S("0x84b460915ae89104c94de2ea3d0ade0245203dc36906f3a9508169b5da0b0d57"));
        ...
        checkpointData = {
            {
                {0, uint256S("ed0d32cd64dab7185bb5317678ea31d338e3847e483f8e0d450e509880873d15")},
            }
        };
