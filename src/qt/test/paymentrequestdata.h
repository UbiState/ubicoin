...
#ifndef UBICOIN_QT_TEST_PAYMENTREQUESTDATA_H
#define UBICOIN_QT_TEST_PAYMENTREQUESTDATA_H
...
//
// Payment request with amount overflow (amount is set to 84000001 ÜBI)
//
...
#endif // UBICOIN_QT_TEST_PAYMENTREQUESTDATA_H
