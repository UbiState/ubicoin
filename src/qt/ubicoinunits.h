...
#ifndef UBICOIN_QT_UBICOINUNITS_H
#define UBICOIN_QT_UBICOINUNITS_H
...
/** Ubicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UbicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UbicoinUnits(QObject *parent);

    /** Ubicoin units.
      @note Source: https://en.ubicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef UbicoinUnits::Unit UbicoinUnit;

#endif // UBICOIN_QT_UBICOINUNITS_H
