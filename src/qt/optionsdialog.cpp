    ...
    mapper(0)
{
    ...
    ui->ubicoinAtStartup->setToolTip(ui->ubicoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ubicoinAtStartup->setText(ui->ubicoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openUbicoinConfButton->setToolTip(ui->openUbicoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new UbicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ubicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUbicoinConfButton_clicked()
{
