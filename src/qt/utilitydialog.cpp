    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ubicoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ubicoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 UBI, 0.01 UBI, 0.1 UBI, 1 UBI and 10 UBI -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.ubicoin.org/en/stable/wallets/ubicoincore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
