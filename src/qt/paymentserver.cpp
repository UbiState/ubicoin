...
const QString BITCOIN_IPC_PREFIX("ubicoin:");
...
void PaymentServer::ipcParseCommandLine(interfaces::Node& node, int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ubicoin: URI
        {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ubicoin: URI
    {
