...
#ifndef UBICOIN_TEST_SCRIPTNUM10_H
#define UBICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ubicoin Core 0.10.0, for cross-comparison.
 */
public:
