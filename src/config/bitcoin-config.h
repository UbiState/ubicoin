...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ubicoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ubicoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/ubistate/ubicoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ubicoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ubicoin Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ubicoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ubistate.org/"
