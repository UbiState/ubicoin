...
def setup():
    ...
    if not os.path.isdir('dash-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/UbiState/dash-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('dash'):
        subprocess.check_call(['git', 'clone', 'https://github.com/UbiState/dash.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/UbiState/dash', help='Specify the URL of the repository. Default is %(default)s')
