...
def setup():
    ...
    if not os.path.isdir('gitian.sigs.ltc'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ubicoin-project/gitian.sigs.ltc.git'])
    if not os.path.isdir('ubicoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ubicoin-project/ubicoin-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('ubicoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/ubicoin-project/ubicoin.git'])
...
def build():
    ...
    subprocess.check_call(['wget', '-N', '-P', 'inputs', 'https://ubicoincore.org/cfields/osslsigncode-Backports-to-1.7.1.patch'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/ubicoin-project/ubicoin', help='Specify the URL of the repository. Default is %(default)s')
