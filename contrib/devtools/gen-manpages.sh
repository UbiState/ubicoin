...
UBICOIND=${UBICOIND:-$BINDIR/ubicoind}
UBICOINCLI=${UBICOINCLI:-$BINDIR/ubicoin-cli}
UBICOINTX=${UBICOINTX:-$BINDIR/ubicoin-tx}
UBICOINQT=${UBICOINQT:-$BINDIR/qt/ubicoin-qt}
