...
pkgdatadir = $(datadir)/ubicoin
pkgincludedir = $(includedir)/ubicoin
pkglibdir = $(libdir)/ubicoin
pkglibexecdir = $(libexecdir)/ubicoin
...
ACLOCAL = ${SHELL} /root/sum/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/sum/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/sum/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/sum/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = ubicoin-cli
BITCOIN_DAEMON_NAME = ubicoind
BITCOIN_GUI_NAME = ubicoin-qt
BITCOIN_TX_NAME = ubicoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Ubicoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Ubicoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/sum/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = ubicoin
PACKAGE_BUGREPORT = https://github.com/ubistate/ubicoin/issues
PACKAGE_NAME = Ubicoin Core
PACKAGE_STRING = Ubicoin Core 0.17.1
PACKAGE_TARNAME = ubicoin
PACKAGE_URL = https://ubistate.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/sum
abs_srcdir = /root/sum
abs_top_builddir = /root/sum
abs_top_srcdir = /root/sum
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/sum/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Ubicoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Ubicoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ubicoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Ubicoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
