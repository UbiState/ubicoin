...
class SegWitTest(UbicoinTestFramework):
    ...
    def test_v0_outputs_arent_spendable(self):
        ...
        for tx in [p2wsh_tx, p2sh_p2wsh_tx]:
            ...
            # Ubicoin: SCRIPT_VERIFY_WITNESS is enforced when segwit is activated
            test_witness_block(self.nodes[0], self.test_node, block, accepted=True, with_witness=False)
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older ubicoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let ubicoind fill it in.
