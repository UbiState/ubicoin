...
"""Verify that starting ubitcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ubitcoin with -h for help text")
        ...
        self.log.info("Start ubitcoin with -version for version information")
        ...
        self.log.info("Start ubitcoind with -fakearg to make sure it does not start")
