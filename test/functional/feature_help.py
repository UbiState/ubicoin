...
"""Verify that starting ubicoin with -h works as expected."""

from test_framework.test_framework import UbicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(UbicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ubicoin with -h for help text")
        ...
        self.log.info("Start ubicoin with -version for version information")
        ...
        self.log.info("Start ubicoind with -fakearg to make sure it does not start")
