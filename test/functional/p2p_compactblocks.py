...
# TestP2PConn: A peer we use to send messages to ubicoind, and store responses.
...
class CompactBlocksTest(UbicoinTestFramework):
    ...
    # This test actually causes ubicoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ubicoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ubicoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ubicoind will not send blocktxn responses for blocks whose height is
