#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Ubicoin Core developers
...
class LLMQCoinbaseCommitmentsTest(UbicoinTestFramework):
    def set_test_params(self):
        self.set_ubicoin_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as UbicoinTestFramework doesn't support this atm)
