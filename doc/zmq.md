...
The Ubicoing Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Ubicoing Core requires ZeroMQ API version 4.x or
...
using. Ubicoingd appends an up-counting sequence number to each
