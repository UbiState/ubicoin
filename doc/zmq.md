...
The Ubicoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Ubicoin Core requires ZeroMQ API version 4.x or
...
using. Ubicoind appends an up-counting sequence number to each
