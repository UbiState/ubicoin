...
* ubitcoin.conf: contains configuration settings for ubitcoind or ubitcoin-qt
* ubitcoind.pid: stores the process id of ubitcoind while running
...
* debug.log: contains debug information and general logging generated by ubitcoind or ubitcoin-qt
