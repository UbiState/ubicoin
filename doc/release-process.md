...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/UbiState/gitian.sigs.ubi.git
...
Ensure your gitian.sigs.ubi are up-to-date if you wish to gverify your builds against other Gitian signatures.

    pushd ./gitian.sigs.ubi
    git pull
    popd
...
### Build and signcoin Core for Linux, Windows, and macOS:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-linux --destination ../gitian.sigs.ubi/ ../ubicoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ubi/ ../ubicoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.ubi/ ../ubicoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  5. Gitian signatures (in `gitian.sigs.ubi/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)
...
Verify the signatures
    ...
    pushd ./gitian-builder
    ./bin/gverify -v -d ../gitian.sigs.ubi/ -r ${VERSION}-linux ../ubicoin/contrib/gitian-descriptors/gitian-linux.yml
    ./bin/gverify -v -d ../gitian.sigs.ubi/ -r ${VERSION}-win-unsigned ../ubicoin/contrib/gitian-descriptors/gitian-win.yml
    ./bin/gverify -v -d ../gitian.sigs.ubi/ -r ${VERSION}-osx-unsigned ../ubicoin/contrib/gitian-descriptors/gitian-osx.yml
    popd

### Next steps:

Commit your signature to gitian.sigs.ubi:
...
Create (and optionally verify) the signed macOS binary:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-signed --destination ../gitian.sigs.ubi/ ../ubicoin/contrib/gitian-descriptors/gitian-osx-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ubi/ -r ${VERSION}-osx-signed ../ubicoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-signed --destination ../gitian.sigs.ubi/ ../ubicoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ubi/ -r ${VERSION}-win-signed ../ubicoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
Commit your signature for the signed macOS/Windows binaries:
    ...
    git commit -a
    git push  # Assuming you can push to the gitian.sigs.ubi tree
    popd
...
space *do not upload these to the ubistate.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the ubistate.org server.

```
- Update ubistate.org version

- Announce the release:

  - ubicoin-dev and ubicoin-dev mailing list

  - blog.ubistate.org blog post
