...
This document provides guidelines for internationalization of the Ubicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ubicoin_en.ts` remains unchanged.
