Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://ubicoin.org/bin/ubicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ubicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ubicoin-tx to create v2 transactions (btcdrak)
