Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/ubicoin/files/Bitcoin/ubicoin-0.7.0/

We recommend that everybody running prior versions of ubicoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/ubicoin/ubicoin/tarball/v0.7.0  # .tar.gz
  https://github.com/ubicoin/ubicoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the ubicoin-qt package:
  sudo apt-get install ubicoin-qt
...
Core ubicoin handling and blockchain database
...
* Ensure a changed ubicoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for ubicoin-qt.exe
* (Windows only): add meta-data to ubicoin-qt.exe (e.g. description)
...
* Bash programmable completion for ubicoind(1)
