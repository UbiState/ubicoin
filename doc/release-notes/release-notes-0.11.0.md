Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://ubicoin.org/bin/ubicoin-core-0.11.0/>
...
For example, add the following to `ubicoin.conf`:
...
related to the blockchain in the ubicoin system: the raw blocks as received over 
...
For an example script see [ubicoin-submittx](https://github.com/laanwj/ubicoin-submittx).
...
- #5334 `cf87536` libubicoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new ubicoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add ubicoin logo to about screen
...
- #5809 `46bfbe7` Add ubicoin-cli man page
...
- #5849 `41259ca` contrib/init/ubicoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for ubicoin-tx)
