...
- [`b0843c397`](https://github.com/UbiState/ubicoin/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Dash-specific rpc (#1502)
...
- [`b39c518d5`](https://github.com/UbiState/ubicoin/commit/b39c518d5) Backport Bitcoin PR#7749: Enforce expected outbound services (#1508)
...
- [`b9c67258b`](https://github.com/UbiState/ubicoin/commit/b9c67258b) Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + Dashify
...
- [`91d99fcd3`](https://github.com/UbiState/ubicoin/commit/91d99fcd3) Backport Bitcoin Qt/Gui changes up to 0.14.x part 3 (#1617)
...
- [`91ae0b712`](https://github.com/UbiState/ubicoin/commit/91ae0b712) Use connman passed to ThreadSendAlert() instead of g_connman global. (#1610)
...
- [`753b1e486`](https://github.com/UbiState/ubicoin/commit/753b1e486) Eliminate remaining uses of g_connman in Dash-specific code. (#1635)
...
- [`7ab175a8e`](https://github.com/UbiState/ubicoin/commit/7ab175a8e) Ensure Dash wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`05da4557d`](https://github.com/UbiState/ubicoin/commit/05da4557d) Refactor masternode management (#1611)
...
- [`715504357`](https://github.com/UbiState/ubicoin/commit/715504357) Dashify bitcoin unix executables (#1486)
