...
- [`df04cdcd2`](https://github.com/UbiState/ubicoin/commit/df04cdcd2) Fix Dash specific docs and scripts
...
- [`595826ad6`](https://github.com/UbiState/ubicoin/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
- [`a1bd147bc`](https://github.com/UbiState/ubicoin/commit/a1bd147bc) Dashify
...
- [`b451094e2`](https://github.com/UbiState/ubicoin/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`f76d53d73`](https://github.com/UbiState/ubicoin/commit/f76d53d73) Dashify a few strings in tests
...
- [`6ec77c0a7`](https://github.com/UbiState/ubicoin/commit/6ec77c0a7) Merge #11131: rpc: Write authcookie atomically
...
- [`a304d4d47`](https://github.com/UbiState/ubicoin/commit/a304d4d47) Fix DashTestFramework and tests depending on it
...
- [`17bb230d7`](https://github.com/UbiState/ubicoin/commit/17bb230d7) Merge #11121: TestNode tidyups
...
- [`ebfec2218`](https://github.com/UbiState/ubicoin/commit/ebfec2218) Dashify BITCOINCLI
...
- [`4049754f4`](https://github.com/UbiState/ubicoin/commit/4049754f4) Dashify test_node.py
- [`96966e5b8`](https://github.com/UbiState/ubicoin/commit/96966e5b8) Use TestNode.node_encrypt_wallet
- [`cc124c99c`](https://github.com/UbiState/ubicoin/commit/cc124c99c) Remove Dash specific leftovers of node.stop optimization
...
- [`c438c9322`](https://github.com/UbiState/ubicoin/commit/c438c9322) Merge #11022: Basic keypool topup
...
- [`40617436c`](https://github.com/UbiState/ubicoin/commit/40617436c) Merge #10179: Give CValidationInterface Support for calling notifications on the CScheduler Thread
...
- [`cb480af01`](https://github.com/UbiState/ubicoin/commit/cb480af01) Dashify
...
- [`746ebf165`](https://github.com/UbiState/ubicoin/commit/746ebf165) fix indendation in wallet.cpp
...
- [`6edcf43fc`](https://github.com/UbiState/ubicoin/commit/6edcf43fc) Merge #10683: rpc: Move the `generate` RPC call to rpcwallet
...
- [`fa2cd234b`](https://github.com/UbiState/ubicoin/commit/fa2cd234b) \#10193 Introduce src/reverse_iterator.hpp and include it...
...
- [`38f52f881`](https://github.com/UbiState/ubicoin/commit/38f52f881) Merge #10816: Properly forbid -salvagewallet and -zapwallettxes for multi wallet.
...
- [`4c61aedfc`](https://github.com/UbiState/ubicoin/commit/4c61aedfc) Merge #10659: [qa] blockchain: Pass on closed connection during generate call
...
- [`e1a146d95`](https://github.com/UbiState/ubicoin/commit/e1a146d95) Merge #10592: [trivial] fix indentation for ArgsManager class
...
- [`b6dc579be`](https://github.com/UbiState/ubicoin/commit/b6dc579be) Merge #10547: [tests] Use FastRandomContext instead of boost::random::{mt19937,uniform_int_distribution}
...
- [`e353d271f`](https://github.com/UbiState/ubicoin/commit/e353d271f) Merge #10359: [tests] functional tests should call BitcoinTestFramework start/stop node methods
...
- [`7ebe41b4b`](https://github.com/UbiState/ubicoin/commit/7ebe41b4b) Merge #10408: Net: Improvements to Tor control port parser
...
- [`5df0a96f7`](https://github.com/UbiState/ubicoin/commit/5df0a96f7) adjust build_src.sh 10189
...
- [`98f3e295c`](https://github.com/UbiState/ubicoin/commit/98f3e295c) add `&& llmq::IsOldInstantSendEnabled()` to instantsend max value check
...
- [`69b42ce67`](https://github.com/UbiState/ubicoin/commit/69b42ce67) Merge #10165: [Wallet] Refactoring by using CInputCoin instead of std::pair
...
- [`250195185`](https://github.com/UbiState/ubicoin/commit/250195185) Adjust CDSNotificationInterface to align with CValidationInterface changes
...
- [`bfd63c179`](https://github.com/UbiState/ubicoin/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/UbiState/ubicoin/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/UbiState/ubicoin/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/UbiState/ubicoin/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/UbiState/ubicoin/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/UbiState/ubicoin/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/UbiState/ubicoin/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/UbiState/ubicoin/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/UbiState/ubicoin/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/UbiState/ubicoin/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/UbiState/ubicoin/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/UbiState/ubicoin/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/UbiState/ubicoin/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/UbiState/ubicoin/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/UbiState/ubicoin/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/UbiState/ubicoin/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/UbiState/ubicoin/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/UbiState/ubicoin/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/UbiState/ubicoin/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/UbiState/ubicoin/commit/67c735b15) s/bitcoin-config.h/ubicoin-config.h/
- [`2f63322cd`](https://github.com/UbiState/ubicoin/commit/2f63322cd) ubicoinify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/UbiState/ubicoin/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/UbiState/ubicoin/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/UbiState/ubicoin/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/UbiState/ubicoin/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/UbiState/ubicoin/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/UbiState/ubicoin/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/UbiState/ubicoin/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/UbiState/ubicoin/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/UbiState/ubicoin/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/UbiState/ubicoin/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/UbiState/ubicoin/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/UbiState/ubicoin/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/UbiState/ubicoin/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/UbiState/ubicoin/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/UbiState/ubicoin/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/UbiState/ubicoin/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/UbiState/ubicoin/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/UbiState/ubicoin/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/UbiState/ubicoin/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/UbiState/ubicoin/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/UbiState/ubicoin/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/UbiState/ubicoin/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/UbiState/ubicoin/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/UbiState/ubicoin/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/UbiState/ubicoin/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/UbiState/ubicoin/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/UbiState/ubicoin/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/UbiState/ubicoin/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/UbiState/ubicoin/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/UbiState/ubicoin/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/UbiState/ubicoin/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/UbiState/ubicoin/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/UbiState/ubicoin/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/UbiState/ubicoin/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/UbiState/ubicoin/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/UbiState/ubicoin/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/UbiState/ubicoin/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/UbiState/ubicoin/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/UbiState/ubicoin/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/UbiState/ubicoin/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/UbiState/ubicoin/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/UbiState/ubicoin/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/UbiState/ubicoin/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/UbiState/ubicoin/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/UbiState/ubicoin/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/UbiState/ubicoin/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/UbiState/ubicoin/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/UbiState/ubicoin/commit/1cfda206a) Merge #9993: Initialize nRelockTime
