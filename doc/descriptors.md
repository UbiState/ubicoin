# Support for Output Descriptors in Ubicoing Core

Since Ubicoing Core v0.17, there is support for Output Descriptors in the
...
on Ubicoing's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ubicoing Core wallets, a convenience function `combo` is
