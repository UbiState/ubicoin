# Support for Output Descriptors in Ubitcoin Core

Since Ubitcoin Core v0.17, there is support for Output Descriptors in the
...
on Ubitcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ubitcoin Core wallets, a convenience function `combo` is
