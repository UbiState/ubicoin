...
git clone https://github.com/UbiState/dash
...
```bash
    ...
    From https://github.com/UbiState/dash
...
[dash/gitian.sigs](https://github.com/UbiState/gitian.sigs/) repository, or if that's not possible to create a pull
request.
