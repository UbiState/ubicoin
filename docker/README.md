...
official/supported Docker Images found at https://hub.docker.com/r/UbiState/dashd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/UbiState/dashd-develop/ when changing the above text**