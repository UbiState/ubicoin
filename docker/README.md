...
official/supported Docker Images found at https://hub.docker.com/r/UbiState/ubicoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/UbiState/ubicoind-develop/ when changing the above text**