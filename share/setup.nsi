...
!define COMPANY "Ubicoin Core project"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Ubicoin Core"
...
!else
InstallDir $PROGRAMFILES\Ubicoin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Ubicoin Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\ubicoin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Ubicoin Core (testnet, -bit).lnk" "$INSTDIR\ubicoin-qt" "-testnet" "$INSTDIR\ubicoin-qt" 1
    ...
    WriteRegStr HKCR "ubicoin" "URL Protocol" ""
    WriteRegStr HKCR "ubicoin" "" "URL:Ubicoin"
    WriteRegStr HKCR "ubicoin\DefaultIcon" "" $INSTDIR\ubicoin-qt
    WriteRegStr HKCR "ubicoin\shell\open\command" "" '"$INSTDIR\ubicoin-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\ubicoin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Ubicoin Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Ubicoin.lnk"
